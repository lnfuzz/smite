...
mod tests {
    ...
    /// P2WPKH `scriptPubKey` from the BOLT 3 dual-funding test vectors.
    ...
    fn roundtrip_p2wsh_script() {
        // 34-byte P2WSH funding output from the BOLT 3 dual-funding vectors.
        let mut script = vec![0x00, 0x20];
        script.extend_from_slice(&[0x29; 32]);
